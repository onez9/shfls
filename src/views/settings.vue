    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="form-check form-switch mt-2">
          <input @click="change_theme" v-model="theme_current" class="form-check-input" type="checkbox" role="switch"
        ...
        <button @click="show_path=!show_path" class="btn btn-outline-primary form-control">Настройка путей</button>
        ...
        <button @click="user.settings.mode = !user.settings.mode"
          class="btn btn-outline-primary form-control mt-2">Настройки пользователя</button>
        ...
        <button class="btn btn-outline-danger mt-2 form-control"><i class=""></i> Сохранить</button>
        <!-- {{ value }}
                {{ theme }} -->
      </div>
    </div>
