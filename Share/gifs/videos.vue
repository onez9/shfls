  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-12 mb-1 mt-1">
        <button :class="{'btn btn-warning form-control': true}" @click="sendMessage('здравствуйте я с клиента')">WebSocket</button>
      ...
      <div class="col-sm-12 pb-1 pt-1" v-for="(item, i) in rx_array" :key="i">
        <figure class="">
          <video class="w-100" poster="/gifs/123.jpg" controls loop>
...
export default {
  data() {
    return {
      // img: '/files/192.168.100.184-kartinkin-com-p-anime-v-realnoi-zhizni-oboi-anime-krasivo-6.jpg',
      array_videos: [],
      url: "",
      re1: '',
      aaa: 1,
  ...
  created() {
    ...
    this.connection = new WebSocket("ws://192.168.100.184:3000")
